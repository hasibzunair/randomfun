...
csvfile = "/home/hasib/PycharmProjects/compVision/road_traffic/report.csv"
filename = "/home/hasib/PycharmProjects/compVision/road_traffic/road_traffic.png"
...
def graph(csvfile, filename):
    ...
    plt.plot_date(x=date, y=value, ls='solid', linewidth=2, color='#FB921D', fmt=':')
